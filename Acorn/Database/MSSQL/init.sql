IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'EOSERV')
BEGIN
...
BEGIN
	CREATE TABLE [dbo].[Characters] (
		[Accounts_Username] NVARCHAR(64) NOT NULL,
		[Name] NVARCHAR(50) NOT NULL,
		[Title] NVARCHAR(50) NOT NULL,
		[Home] NVARCHAR(50) NOT NULL,
		[Fiance] NVARCHAR(50) NOT NULL,
		...
		[Paperdoll] NVARCHAR(MAX) NOT NULL,
		[Spells] NVARCHAR(MAX) NOT NULL,
		[Guild] NVARCHAR(50) NOT NULL,
		[GuildRank] INT NOT NULL,
		[GuildRankString] NVARCHAR(50) NOT NULL,
		[Quest] NVARCHAR(MAX) NOT NULL
	);
END

IF NOT EXISTS (SELECT * FROM sys.server_principals WHERE name = 'EOSERV')
BEGIN
    CREATE LOGIN EOSERV WITH PASSWORD = 'EOSERV';
END
GO
...
BEGIN
    CREATE USER EOSERV FOR LOGIN EOSERV;
END
GO
